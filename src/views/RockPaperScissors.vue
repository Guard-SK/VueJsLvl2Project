...
<main>
    <div class="container">
        <div>
            ...
            <div class="wrapper">
                <input type="radio" name="select" id="option-1" value="K" v-model="checkbox_data">
                <input type="radio" name="select" id="option-2" value="P" v-model="checkbox_data">
                <input type="radio" name="select" id="option-3" value="N" v-model="checkbox_data">
            ...
            <div> 
                <h2 v-bind:style="{ color: activeColor }" class="result" >{{result_data}}</h2>
            </div>
        </div>
        <div>
...
export default {
  ...
  methods: {
    ...
    history(result_text) {
      ...
      if (this.name != '') {
          this.history_data = this.history_data + '\n' + this.name+' has ' + result_text + '. ' + 'Score is '+ this.score
      } else {
          this.history_data = this.history_data + '\n' + 'Guest'+' has ' + result_text + '. ' + 'Score is '+ this.score
      }
    },
    reset_history() {
        this.history_data = ''
